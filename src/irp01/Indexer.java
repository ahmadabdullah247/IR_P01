...
public class Indexer {
	...
	private Document getDocument(File file) {
		...
		try {
			...
			Field filePathValue = new Field(LuceneInitializr.FILE_PATH, file.getCanonicalPath(), filePathField);
			Field fileTimeStamp = new Field(LuceneInitializr.FILE_TIMESTAMP, sdf.format(file.lastModified()).toString(),
					fileTimeStampField);
